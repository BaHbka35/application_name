# Generated by Django 4.0 on 2022-01-12 12:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='field intends for useing in url (slug)')),
                ...
                ('training_experience', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, verbose_name='How long does user train in total')),
                ('trains_now', models.BooleanField(blank=True, null=True, verbose_name='Does user train now')),
                ('registration_date', models.DateTimeField(auto_now_add=True, verbose_name='Date when user was registrated')),
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Is user active or his account was deleted?')),
